...
# Develop the "Naive" Player Recommendation Algorithm
def recommend_players(user_roster, available_players, df, roster_structure, top_n=3):
    ...
    available_df['SCORE'] += (max_rank - available_df['RK']) * 0.25  # Higher rank (lower number) gets higher score
...
# Create a function to output the recommended players
